...
const I = {
    ...
    w = ["id", "accept", "multiple", "required", "aria-required", "aria-invalid", "disabled"],
    G = {
        __name: "TUploadFile",
        props: {
            id: String,
                    ...
                    [
                        m(
                            "input",
                            {
                                ...
                                onChange:
                                    i[0] ||
                                    (i[0] = (l) => a.$emit("update:modelValue", !e.modelValue)),
                                "aria-required": e.required,
                                "aria-invalid": e.error,
                                disabled: e.disabled,
                            },
    ...
    D = ["id", "placeholder", "rows", "required", "aria-required", "aria-invalid", "disabled"],
    H = {
        __name: "TTextarea",
        props: {
            modelValue: String,
    ...
    O = ["id", "required", "aria-required", "aria-invalid"],
    R = ["value", "disabled", "selected"],
    z = {
        __name: "TSelect",
        props: {
            id: String,
                ...
                l = T(
                    i.options.map((t) => {
                        ...
                        return {
                            ...t,
                            checked:
                                f((d = i.modelValue) == null ? void 0 : d.includes(t.id)) || !1,
                        }
                    })
                ),
                o = a
    ...
    J = ["id", "required", "checked", "onChange", "aria-required", "aria-invalid", "disabled"],
    K = {
        __name: "TGroupRadio",
        props: {
            options: Array,
    ...
    W = {
        install: (e, a) => {
            e.component("TFormGroup", I),
                e.component("TLabel", v),
                e.component("TInputField", F),
                e.component("TUploadFile", G),
                e.component("TCheckbox", S),
                e.component("TError", E),
                e.component("THint", N),
                e.component("TTextarea", H),
                e.component("TSelect", z),
                e.component("TGroupCheckbox", j),
                e.component("TGroupRadio", K)
        },
    }
export { W as default }
